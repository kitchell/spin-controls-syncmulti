 ...
 * @author Lindsey Kitchell / lindseykitchell.weebly.com
 */

var SpinControlsSyncMulti = function ( objectList, trackBallRadius, camera, domElement ) {
...
//    this.chosenObject = objectList[0];
...
//            console.log(_this.chosenObject)
			// Intersect mouse on plane at object with normal pointing to camera

			objectPos.setFromMatrixPosition( _this.chosenObject.matrixWorld );
	...
	this.applyVelocity = ( function () {
		...
		return function applyVelocity() {
            ...
            _this.objectList.forEach(function(obj){
				...
				if ( 8 * ( 1 - _lastQuaternion.dot( obj.quaternion ) ) > _EPS) {

					_this.dispatchEvent( changeEvent );

					_lastQuaternion.copy( obj.quaternion );
...
SpinControlsSyncMulti.prototype = Object.create( THREE.EventDispatcher.prototype );
SpinControlsSyncMulti.prototype.constructor = SpinControlsSyncMulti;